...
export function TopicsSection() {
  ...
  const handleEditClick = (topic: Topic) => {
    ...
    setEditSchoolClass(topic.school_class);
    setIsEditOpen(true);
  };
  ...
  const handleUpdateTopic = async (e: React.FormEvent) => {
    ...
    try {
      await contentAPI.updateTopic(selectedTopic.id, {
        title: editTitle,
        slug,
        school_class: editSchoolClass,
        parent_id: selectedTopic.parent_id ?? null,
      });
        ...
        <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
          ...
          <DialogContent className='bg-gray-900 border-gray-700'>
            ...
            <form onSubmit={handleCreateTopic} className='space-y-4'>
              ...
              <div className='space-y-2'>
                <Label htmlFor='schoolClass' className='text-gray-300'>
                  Class
                </Label>
                <select
                  id='schoolClass'
          ...
          >
            <CardHeader>
              ...
              <CardDescription className='text-gray-400'>
                {topic.school_class ? `Class: ${topic.school_class}` : 'No class'}
              </CardDescription>
            </CardHeader>
      ...
      <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
        <DialogContent className='bg-gray-900 border-gray-700'>
          ...
          <form onSubmit={handleUpdateTopic} className='space-y-4'>
            ...
            <div className='space-y-2'>
              <Label htmlFor='editSchoolClass' className='text-gray-300'>
                Class
              </Label>
              <select
                id='editSchoolClass'
