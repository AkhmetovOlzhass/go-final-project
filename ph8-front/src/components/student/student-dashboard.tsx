...
export function StudentDashboard() {
  ...
  const filterTasks = () => {
    ...
    if (selectedTopicId && selectedTopicId !== 'all') {
      filtered = filtered.filter((task) => task.topic_id === selectedTopicId);
    }
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12'>
          <div className='text-center space-y-4 sm:space-y-6'>
            ...
            <p className='text-lg sm:text-xl text-gray-300 max-w-2xl mx-auto text-balance leading-relaxed'>
              Master physics through interactive problem-solving. Challenge yourself with real-world
              scenarios and build your understanding step by step.
            </p>
          </div>
        </div>
      </div>
